...
The scale parameter for the models are : for model in part 1) the scale parameter is 2.67 and the for the model in part 4) the scale parameter is 1.64. Both of them are greater than 1,so that we need to account for overdispersion.
